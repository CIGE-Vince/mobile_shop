...
public class HandleBuyGoods extends HttpServlet {
   ...
   public  void  doPost(HttpServletRequest request,HttpServletResponse response) 
      ...
      String uri="jdbc:mysql://127.0.0.1:3306/mobileshop?"+
                             "user=root&password=2535663&characterEncoding=utf-8";
      Connection con; 
   ...
   public void success(HttpServletRequest request,HttpServletResponse response,
        ...
        try {
         ...
         out.println("<center><h2>"+backNews+"</h2></center>");
         out.println("<br>");
         out.println("<center><br><a href =index.jsp>主页</a>");
         out.println("<br>");
         out.println("<br><a href =lookOrderForm.jsp>查看订单</a></center>");
